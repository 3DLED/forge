...
CORE = [
    ...
    ("row", "Remo", MS),
    ("goblet squat", "Sentadilla goblet", FS),
    ("overhead squat", "Sentadilla sobre la cabeza", FS),
    ("bulgarian split squat", "Sentadilla búlgara", FS),
    ("pistol squat", "Sentadilla a una pierna", FS),
    ("wall sit", "Sentadilla isométrica", FS),
    ("nordic curl", "Curl nórdico", MS),
